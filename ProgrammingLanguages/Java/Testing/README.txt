...
Running the tests
-----------------
First, compile the class you want to test. Then, compile the class that tests the other class by typing "javac -cp .;junit-4.XX.jar <test_name>.java". Run the tests by typing "java -cp .;junit-4.XX.jar;hamcrest-core-1.3.jar org.junit.runner.JUnitCore <test_name>".
