...
mock creates false objects that can immitate objects that we are testing. Useful when there is no internet, but we have to test a function that grabs data from the internet.
...
How to use Nose:
1) Create two folders, one with a test and another with functions you want to test
